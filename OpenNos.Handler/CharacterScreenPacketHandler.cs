                ...
                if (Session != null && Session.Account != null && !Session.HasSelectedCharacter)
                {
                    ...
                    if (characterDTO != null)
                    {
                        Session.SetCharacter(new Character(Session)
                        {
                            ...
                            FamilyId = characterDTO.FamilyId,
                            FamilyInfo = characterDTO.FamilyInfo,
                            FamilyLevel = characterDTO.FamilyLevel,
                            FamilyName = characterDTO.FamilyName,
                            FamilyPosition = characterDTO.FamilyPosition
                        });
